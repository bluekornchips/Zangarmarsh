...
install the local quest-log plugin, and overwrite host Cursor user settings from
`tools/vscode/settings.json` via `questlog`. Optional cleanup runs only with
